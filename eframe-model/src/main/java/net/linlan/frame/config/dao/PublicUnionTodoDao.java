...
/**
*
* PublicUnionTodo数据域:统一超级待办持久层Dao
* @author Linlan
* CreateTime 2023-10-02 22:29:22
*
*/
@Mapper
public interface PublicUnionTodoDao extends MybatisBaseDao<PublicUnionTodo> {
     ...
     */
    Page<PublicUnionTodoDto> getPageDto(PublicUnionTodoParam param);
     ...
     */
    PublicUnionTodoDto getDtoById(String id);
