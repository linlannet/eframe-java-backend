...
/**
*
* SysPostype数据域:岗位分类表持久层Dao
* @author Linlan
* CreateTime 2018-03-02 17:19:48
*
*/
@Mapper
public interface CorePostypeDao extends MybatisBaseDao<CorePostype> {
     ...
     */
    Page<CorePostypeDto> getPageDto(CorePostypeParam param);
     ...
     */
    CorePostypeDto getDtoById(String id);
