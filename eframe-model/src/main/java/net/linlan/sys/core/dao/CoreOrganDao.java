...
/**
*
* SysOrgan数据域:系统机构表持久层Dao
* @author Linlan
* CreateTime 2023-08-12 13:45:50
*
*/
@Mapper
public interface CoreOrganDao extends MybatisBaseDao<CoreOrgan> {
     ...
     */
    Page<CoreOrganDto> getPageDto(CoreOrganParam param);
     ...
     */
    CoreOrganDto getDtoById(String id);
