...
/**
*
* CoreDepttype数据域:部门业务分类表持久层Dao
* @author Linlan
* CreateTime 2018-05-09 10:09:40
*
*/
@Mapper
public interface CoreDepttypeDao extends MybatisBaseDao<CoreDepttype> {
     ...
     */
    Page<CoreDepttypeDto> getPageDto(CoreDepttypeParam param);
     ...
     */
    CoreDepttypeDto getDtoById(Long id);

    List<TreeNode> getDeptTypeChildren(TreeParam treeParam);
