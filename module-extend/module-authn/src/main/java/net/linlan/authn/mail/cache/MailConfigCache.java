 ...
 */
package net.linlan.authn.mail.cache;
...
public class MailConfigCache {
     ...
     * 邮件平台轮询KEY
     */
    private final String       SMS_ROUND_KEY      = "module_ext:mail:round";
    private final String       SMS_ROUND_CODE_KEY = "module_ext:mail:round:code";

    /**
     * 邮件平台列表KEY
     */
    private final String       SMS_PLATFORM_KEY   = "module_ext:mail:providerName";
    ...
    public List<MailConfigVo> list() {
        return (List<MailConfigVo>) redisCache.get(SMS_PLATFORM_KEY);
    }

    public void save(List<MailConfigVo> list) {
