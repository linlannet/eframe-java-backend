...
public class JasyptPropertyValueHandler extends PropertyOverrideConfigurer
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        MutablePropertySources propertySources = ((StandardServletEnvironment) environment)
            .getPropertySources();
    ...
    public void convertPropertySources(MutablePropertySources propSources) {
        ...
        StreamSupport.stream(propSources.spliterator(), false)
            .filter(ps -> (ps instanceof OriginTrackedMapPropertySource)
                          || (ps instanceof SimpleCommandLinePropertySource))
            .forEach(ps -> {
    ...
    private void handleCommandLine(PropertySource ps) {
        try {
            ...
            Map<String, List<String>> result = (Map<String, List<String>>) valueField
                .get(commandLineArgs);
            for (String key : result.keySet()) {
