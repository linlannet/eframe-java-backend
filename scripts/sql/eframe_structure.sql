...
CREATE TABLE `ADMIN_DEPT`  (
                               ...
                               `STATUS` int(0) NULL DEFAULT NULL COMMENT '状态0未生效1正常2受限3锁定4删除',
...
CREATE TABLE `ADMIN_USER`  (
                               ...
                               `STATUS` int(0) NOT NULL DEFAULT 1 COMMENT '状态0未生效1正常2受限3锁定4删除',
...
CREATE TABLE `SYS_POSITION`  (
                                 ...
                                 `POS_NATURE` int(0) NULL DEFAULT 1 COMMENT '岗位性质0未生效1启用，STATUS，状态0未生效1正常2受限3锁定4删除',
