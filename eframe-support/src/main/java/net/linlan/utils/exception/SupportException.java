...
public class SupportException extends RuntimeException {
    ...
    public SupportException(String msg, Throwable t) {
        super(msg, t);
    ...
    public SupportException(String msg, HttpStatus status) {
        this(DEFAULT_EXCEPTION, msg, status);
    }

    public SupportException(String error, String description) {
        super(description);
        this.error = error;
        this.status = DEFAULT_STATUS;
    }

    public SupportException(String error, String description, HttpStatus status) {
        super(description);
        this.error = error;
        this.status = status;
    }

    public SupportException(Throwable cause, String error, String description, HttpStatus status) {
    ...
    /**
     * Creates an {@link SupportException} from a {@link Map}.
     *
     * @param errorParams a map with additional error information
     * @return the exception with error information
     */
    public static SupportException valueOf(Map<String, String> errorParams) {
        ...
        SupportException ex = new SupportException(errorCode, errorMessage, status);
