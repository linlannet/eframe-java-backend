...
public class HttpResponseUtils {
    ...
    public static void flushResponseJson(HttpServletResponse httpServletResponse, int status,
                                         ObjectMapper objectMapper, Object data) {
        try {
            ...
            if (ObjectUtils.isNotEmpty(data)) {
                // 将对象序列化为JSON并写入响应
                objectMapper.writeValue(httpServletResponse.getWriter(), data);
            } else {
