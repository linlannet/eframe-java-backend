...
public final class SecuritySettingConstants {
     ...
     * 登录失败持续时间
     */
    public static final String              SECURITY_BASIC_LOGIN_FAILURE_DURATION           = SECURITY_DEFENSE_POLICY_PREFIX
                                                                                              + "basic_login_failure_duration";
    /**
     * 登录失败次数
     */
    public static final String              SECURITY_BASIC_LOGIN_FAILURE_COUNT              = SECURITY_DEFENSE_POLICY_PREFIX
                                                                                              + "login_failure_count";

    /**
     * 登录失败自动解锁时间
     */
    public static final String              SECURITY_BASIC_AUTO_UNLOCK_TIME                 = SECURITY_DEFENSE_POLICY_PREFIX
                                                                                              + "login_failure_duration";
     ...
     * 验证码名称
     */
    public static final String              CAPTCHA_SETTING_NAME                            = SECURITY_DEFENSE_POLICY_PREFIX
                                                                                              + "captcha_setting_name";
    ...
    static {
        ...
        SECURITY_DEFENSE_POLICY_DEFAULT_SETTINGS.put(
            ...
            "default-src 'self' data:; " + "frame-src 'self' login.dingtalk.com open.weixin.qq.com open.work.weixin.qq.com passport.feishu.cn data:; "
                                                             + "frame-ancestors 'self' linlan.net/eframe data:; "
        ...
        SECURITY_DEFENSE_POLICY_DEFAULT_SETTINGS.put(SECURITY_DEFENSE_POLICY_LOGIN_FAILURE_DURATION,
            "5");
        //连续登录失败次数
        SECURITY_DEFENSE_POLICY_DEFAULT_SETTINGS.put(SECURITY_DEFENSE_POLICY_FAILURE_COUNT, "3");
        //自动解锁时间（分）
        SECURITY_DEFENSE_POLICY_DEFAULT_SETTINGS.put(SECURITY_DEFENSE_POLICY_AUTO_UNLOCK_TIME, "3");
    }
